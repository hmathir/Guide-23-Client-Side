    ...
    return (
        <div className="">
            <div className="w-11/12 mx-auto max-w-md p-8 space-y-3 rounded-xl  border border-black mt-20">
                <h1 className="text-2xl font-bold text-[#BE123B]  text-center">Login</h1>
                <form onSubmit={handleSingIn} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <button className="block w-full p-3 text-center bg-[#BE123B]   text-white rounded-lg">Sign in</button>
                </form>
